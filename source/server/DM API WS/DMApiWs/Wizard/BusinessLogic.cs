...
namespace DM_API_WS.Wizard
{
  ...
  ""initialize"": true
        ...
        {
            DataProvider.IUtilsDataProvider provider = null;
            try
            {
                provider = Factory.UtilsDataProv;
            }
            catch (Exception)
            {
            ...
            if (provider != null)
            {
                try
                {
                    configData.StatusDDB = provider.CheckInizializedDDB();
                }
                catch (Exception ex)
                {
        ...
        public ConfigData InizializeDDB()
        {
            ...
            if (configData.StatusDDB.HasValue && !configData.StatusDDB.Value)
            {
        ...
        public ConfigData InizializeRMDB()
        {
            ...
            if (configData.StatusRMDB.HasValue && !configData.StatusRMDB.Value)
            {
